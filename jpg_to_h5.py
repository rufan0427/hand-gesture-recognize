...
def process_images_to_h5(image_dir, output_h5_path):
    ...
    with h5py.File(output_h5_path, 'w') as f_out:
        # 创建数据集
        f_out.create_dataset('images', shape=(0, 224, 224, 3), 
                           maxshape=(None, 224, 224, 3), dtype='uint8')
        ...
        for img_file in tqdm(image_files, desc="Processing Images"):
            ...
            if results.multi_hand_landmarks:
                ...
                for ds_name, data in [
                    ('images', img_resized),
                    ('keypoints', kps),
                    ('labels', int(img_file.split('.')[0])),  # 假设文件名是标签 (1.jpg → 标签1)
...
if __name__ == "__main__":
    image_dir = "archive3"  # 存放 1.jpg, 2.jpg...的文件夹
    output_h5_path = "archive3/processed_images.h5"
